      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <Link
              href="/book"
              className="bg-green-500 hover:bg-green-600 text-white px-5 py-2.5 rounded-md font-medium transition-colors"
            >
              Book Appointment
            </Link>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-100">
            <div className="flex flex-col gap-4">
              ...
              <Link
                href="/book"
                className="bg-green-500 text-white px-5 py-2.5 rounded-md font-medium text-center"
              >
                Book Appointment
              </Link>
            </div>
