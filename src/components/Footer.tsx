      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            {/* Social media links - uncomment and update href values when ready
            <div className="flex gap-4">
              <a href="#" className="w-9 h-9 bg-neutral-800 hover:bg-neutral-700 rounded-lg flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="/services#cupping" className="hover:text-white transition-colors">Cupping Therapy</Link></li>
              <li><Link href="/services#moxibustion" className="hover:text-white transition-colors">Moxibustion</Link></li>
              <li><Link href="/services#tuina" className="hover:text-white transition-colors">Tui Na Massage</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span>24 S Broadway<br/>Frostburg, MD 21532</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="tel:7174905991" className="hover:text-white transition-colors">(717) 490-5991</a>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-5 h-5 text-neutral-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                </svg>
                <a href="mailto:info@atlasintegrativeclinic.com" className="hover:text-white transition-colors">info@atlasintegrativeclinic.com</a>
              </li>
            </ul>
          </div>
        </div>
