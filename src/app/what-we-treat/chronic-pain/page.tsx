...
export default function ChronicPainPage() {
  ...
  const benefits = [
    {
      title: "Reduced Medication Reliance",
      description: "Natural pain relief that decreases dependence on pharmaceutical interventions",
      icon: (
    ...
    },
    {
      ...
      description: "Restore range of motion and functional movement for daily activities",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Sustainable pain management through addressing root causes",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Return to activities you love with reduced pain and greater comfort",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="relative py-16 lg:py-24 bg-gradient-to-br from-sage-50 via-white to-sage-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              ...
              restore function, and enhance your quality of life.
            </p>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p>
                    Chronic pain affects every aspect of life—from physical mobility to emotional well-being.
                    Our evidence-based approach combines Traditional Chinese Medicine with modern pain science
                    to provide effective, sustainable relief.
                  </p>
                  <p>
                    We use targeted acupuncture, manual therapy, and neuromuscular modulation to reduce inflammation,
                    enhance circulation, and regulate the nervous system's pain response. Unlike treatments that merely
                    mask symptoms, we address the underlying causes of pain.
                  </p>
                  <p>
                    Each treatment plan is personalized to your unique condition, considering lifestyle factors,
                    stress levels, and functional goals to achieve lasting results.
                  </p>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-sage-50 to-white p-8 rounded-2xl border border-sage-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Thorough evaluation of pain patterns, triggers, and underlying factors to create a personalized treatment strategy.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-sage-50 to-white p-8 rounded-2xl border border-sage-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Precision acupuncture and manual therapy techniques that modulate pain signals and promote natural healing.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-sage-50 to-white p-8 rounded-2xl border border-sage-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Continuous monitoring and treatment adjustments to ensure sustained progress and long-term pain management.
                </p>
              </div>
            </div>
          </div>
