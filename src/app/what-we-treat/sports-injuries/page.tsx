  ...
  const benefits = [
    {
      ...
      description: "Accelerate healing and reduce recovery time from sports injuries",
      icon: (
    ...
    },
    {
      ...
      description: "Natural anti-inflammatory effects that reduce pain and swelling",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Maintain muscle balance and flexibility to prevent future injuries",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Optimize athletic performance and competitive edge",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="bg-sage-50 py-4 border-b border-sage-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="flex items-center gap-2 text-sm">
              ...
              <span className="text-black font-medium">Sports Injuries & Athletic Performance</span>
            </nav>
          </div>
        </section>
        ...
        <section className="relative py-16 lg:py-24 bg-gradient-to-br from-sage-50 via-white to-sage-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="font-serif text-4xl lg:text-5xl font-light text-gray-900 mb-6 leading-tight">
              Sports Injuries & <span className="italic text-black">Athletic Performance</span>
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed">
              Recover faster, perform better, and prevent future injuries with specialized treatments
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="font-serif text-3xl lg:text-4xl font-light text-gray-900 mb-6">
                  Accelerated Recovery & <span className="italic text-black">Performance</span>
                </h2>
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p>
                    Whether you're a professional athlete or weekend warrior, sports injuries can sideline
                    your training and impact your performance. Our specialized treatments accelerate recovery,
                    reduce pain, and help you return to your sport stronger than before.
                  </p>
                  <p>
                    Using targeted acupuncture, sports massage, and neuromuscular techniques, we address acute
                    injuries, chronic overuse conditions, and muscle imbalances. Our approach reduces inflammation,
                    promotes tissue repair, and optimizes biomechanical function for peak athletic performance.
                  </p>
                  <p>
                    Beyond injury treatment, we work with athletes to prevent future injuries, enhance recovery
                    between training sessions, and optimize overall performance through individualized care plans.
                  </p>
                </div>
              </div>

              <div className="relative">
                <div className="aspect-[3/2] rounded-2xl overflow-hidden bg-gradient-to-br from-sage-100 to-sage-200">
                  <img
                    src="/images/treats/sports-injuries.jpg"
                    alt="Baseball player swinging a bat against an ink-wash landscape"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Our specialized treatments address a wide range of sports-related injuries
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                A comprehensive athletic care strategy that addresses injury and performance
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-sage-50 to-white p-8 rounded-2xl border border-sage-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Detailed evaluation of injury mechanism, biomechanics, and contributing factors to create targeted treatment.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-sage-50 to-white p-8 rounded-2xl border border-sage-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Sports acupuncture, manual therapy, and therapeutic techniques that promote rapid tissue healing.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-sage-50 to-white p-8 rounded-2xl border border-sage-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Ongoing care to optimize recovery, prevent reinjury, and enhance athletic performance.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="relative py-20 lg:py-24 bg-gradient-to-br from-sage-600 via-sage-700 to-sage-800 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <h2 className="font-serif text-4xl lg:text-5xl font-light text-white mb-6 leading-tight">
              Ready to Recover <span className="italic">Faster?</span>
            </h2>
            <p className="text-xl text-white mb-10 max-w-2xl mx-auto leading-relaxed">
              Schedule a consultation to discover how our sports injury treatments can accelerate your recovery and enhance performance.
            </p>
