  ...
  const benefits = [
    {
      ...
      description: "Strengthen natural defenses and improve resilience to illness",
      icon: (
    ...
    },
    {
      ...
      description: "Restore vitality and combat fatigue through balanced wellness",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Maintain optimal health and prevent future health issues",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="bg-sage-50 py-4 border-b border-sage-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="flex items-center gap-2 text-sm">
              ...
              <span className="text-black font-medium">General Health & Wellness</span>
            </nav>
          </div>
        </section>
        ...
        <section className="relative py-16 lg:py-24 bg-gradient-to-br from-sage-50 via-white to-sage-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="font-serif text-4xl lg:text-5xl font-light text-gray-900 mb-6 leading-tight">
              General Health & <span className="italic text-black">Wellness</span>
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed">
              Achieve optimal wellness through holistic care that addresses the whole person—supporting
              your body's natural healing abilities and promoting long-term vitality.
            </p>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="font-serif text-3xl lg:text-4xl font-light text-gray-900 mb-6">
                  Comprehensive Holistic <span className="italic text-black">Care</span>
                </h2>
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p>
                    General health and wellness form the foundation of a vibrant, fulfilling life. Our holistic
                    approach recognizes that true health extends beyond the absence of disease to encompass
                    physical vitality, mental clarity, and emotional balance.
                  </p>
                  <p>
                    Through personalized acupuncture, herbal medicine, and lifestyle counseling, we address
                    common health concerns while strengthening your body's innate healing capacity. Whether
                    you're dealing with fatigue, digestive issues, or simply seeking preventive care, we create
                    treatment plans tailored to your unique constitution.
                  </p>
                  <p>
                    Our preventive wellness approach helps you maintain optimal health, build resilience against
                    illness, and enhance your overall quality of life through natural, time-tested therapies.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="aspect-[3/2] rounded-2xl overflow-hidden bg-gradient-to-br from-sage-100 to-sage-200">
                  <img
                    src="/images/treats/general-health.jpg"
                    alt="Traditional Chinese herbs, tea, and acupuncture needles beside a mountain-view window"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Our holistic treatments support a wide range of general health concerns
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                A whole-person wellness strategy that promotes lasting health and vitality
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-sage-50 to-white p-8 rounded-2xl border border-sage-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Comprehensive assessment of your health history, lifestyle, and wellness goals to create personalized care.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-sage-50 to-white p-8 rounded-2xl border border-sage-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Combination of acupuncture, herbal medicine, and lifestyle guidance tailored to your individual needs.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-sage-50 to-white p-8 rounded-2xl border border-sage-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Proactive care that maintains balance, strengthens immunity, and prevents illness before it manifests.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="relative py-20 lg:py-24 bg-gradient-to-br from-sage-600 via-sage-700 to-sage-800 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <p className="text-xl text-white mb-10 max-w-2xl mx-auto leading-relaxed">
              Schedule a consultation to discover how holistic wellness care can help you achieve vibrant health and lasting vitality.
            </p>
