  ...
  const benefits = [
    {
      ...
      description: "Regulate cycles and restore natural hormonal equilibrium",
      icon: (
    ...
    },
    {
      ...
      description: "Alleviate menstrual pain, PMS, and menopausal discomfort",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Enhance reproductive health and support conception",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Achieve optimal health at every stage of life",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="bg-sage-50 py-4 border-b border-sage-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="flex items-center gap-2 text-sm">
              ...
              <span className="text-black font-medium">Women's Health & Wellness</span>
            </nav>
          </div>
        </section>
        ...
        <section className="relative py-16 lg:py-24 bg-gradient-to-br from-sage-50 via-white to-sage-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="font-serif text-4xl lg:text-5xl font-light text-gray-900 mb-6 leading-tight">
              Women's Health & <span className="italic text-black">Wellness</span>
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed">
              Compassionate holistic care supporting women through every stage of life—from menstrual
              health and fertility to pregnancy, postpartum, and menopause.
            </p>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="font-serif text-3xl lg:text-4xl font-light text-gray-900 mb-6">
                  Comprehensive Women's <span className="italic text-black">Healthcare</span>
                </h2>
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p>
                    Women's health encompasses a unique set of physiological experiences and challenges
                    throughout the life cycle. Our specialized approach honors the natural rhythms of the
                    feminine body while addressing hormonal imbalances, menstrual concerns, and reproductive health.
                  </p>
                  <p>
                    Through gentle acupuncture, customized herbal formulas, and nutritional guidance, we support
                    regular menstrual cycles, ease PMS symptoms, enhance fertility, and provide comfort during
                    pregnancy and menopause. Our treatments work with your body's innate wisdom to restore
                    balance and promote optimal wellness.
                  </p>
                  <p>
                    Each treatment plan is tailored to your unique hormonal landscape, life stage, and health
                    goals—providing compassionate care that empowers you to thrive at every phase of your journey.
                  </p>
                </div>
              </div>

              <div className="relative">
                <div className="aspect-[1536/1024] rounded-2xl overflow-hidden bg-gradient-to-br from-sage-100 to-sage-200">
                  <img
                    src="/images/treats/womens-health.jpg"
                    alt="Smiling woman beside a Comprehensive Women’s Healthcare message"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Our specialized treatments address a wide range of women's health concerns
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                A compassionate, whole-woman approach to health at every life stage
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-sage-50 to-white p-8 rounded-2xl border border-sage-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Detailed evaluation of menstrual patterns, hormonal balance, and reproductive health concerns.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-sage-50 to-white p-8 rounded-2xl border border-sage-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Acupuncture and herbal medicine that regulate hormones, support fertility, and ease symptoms naturally.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-sage-50 to-white p-8 rounded-2xl border border-sage-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Ongoing care through all life stages—from menstruation through menopause and beyond.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="relative py-20 lg:py-24 bg-gradient-to-br from-sage-600 via-sage-700 to-sage-800 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <h2 className="font-serif text-4xl lg:text-5xl font-light text-white mb-6 leading-tight">
              Ready to Support Your <span className="italic">Wellness?</span>
            </h2>
            <p className="text-xl text-white mb-10 max-w-2xl mx-auto leading-relaxed">
              Schedule a consultation to discover how specialized women's health care can help you thrive at every stage of life.
            </p>
