  ...
  const benefits = [
    {
      ...
      description: "Restore energy, stamina, and overall masculine vitality",
      icon: (
    ...
    },
    {
      ...
      description: "Optimize testosterone and hormone levels naturally",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Build capacity to handle stress and prevent burnout",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Achieve peak physical and mental performance",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="bg-sage-50 py-4 border-b border-sage-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="flex items-center gap-2 text-sm">
              ...
              <span className="text-black font-medium">Men's Health & Wellness</span>
            </nav>
          </div>
        </section>
        ...
        <section className="relative py-16 lg:py-24 bg-gradient-to-br from-sage-50 via-white to-sage-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="font-serif text-4xl lg:text-5xl font-light text-gray-900 mb-6 leading-tight">
              Men's Health & <span className="italic text-black">Wellness</span>
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed">
              Specialized holistic care addressing the unique health needs of men—from vitality and
              hormonal balance to stress management and peak performance.
            </p>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="font-serif text-3xl lg:text-4xl font-light text-gray-900 mb-6">
                  Comprehensive Men's <span className="italic text-black">Healthcare</span>
                </h2>
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p>
                    Men face unique health challenges throughout life—from managing stress and maintaining
                    vitality to addressing hormonal changes and preventing chronic disease. Our specialized
                    approach recognizes the distinct physiology and wellness needs of men at every life stage.
                  </p>
                  <p>
                    Through personalized acupuncture, herbal medicine, and lifestyle guidance, we address
                    common men's health concerns including low energy, hormonal imbalances, prostate health,
                    and sexual wellness. Our treatments support optimal testosterone levels, improve circulation,
                    and enhance overall masculine vitality.
                  </p>
                  <p>
                    Whether you're seeking preventive care, managing specific health concerns, or optimizing
                    performance, we create tailored treatment plans that help you achieve your health goals
                    and maintain peak wellness.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="aspect-[1402/1122] rounded-2xl overflow-hidden bg-gradient-to-br from-sage-100 to-sage-200">
                  <img
                    src="/images/treats/mens-health.jpg"
                    alt="Smiling man in a clinic beside a Comprehensive Men’s Healthcare sign"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Our specialized treatments address a wide range of men's health concerns
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                A holistic wellness strategy tailored to men's unique physiology and health goals
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-sage-50 to-white p-8 rounded-2xl border border-sage-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Comprehensive evaluation of vitality, hormonal health, and lifestyle factors affecting wellness.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-sage-50 to-white p-8 rounded-2xl border border-sage-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Acupuncture and herbal formulas that support hormonal balance, energy, and masculine vitality.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-sage-50 to-white p-8 rounded-2xl border border-sage-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Ongoing support for peak physical performance, stress management, and long-term health maintenance.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="relative py-20 lg:py-24 bg-gradient-to-br from-sage-600 via-sage-700 to-sage-800 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <h2 className="font-serif text-4xl lg:text-5xl font-light text-white mb-6 leading-tight">
              Ready to Optimize Your <span className="italic">Health?</span>
            </h2>
            <p className="text-xl text-white mb-10 max-w-2xl mx-auto leading-relaxed">
              Schedule a consultation to discover how specialized men's health care can help you achieve vitality and peak wellness.
            </p>
